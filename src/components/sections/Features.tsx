...
import { Database, BarChart3, Workflow, GraduationCap } from 'lucide-react';
...
const FeatureCard = ({ 
  ...
  return (
    <div 
      className="bg-white rounded-xl p-8 shadow-md border border-gray-100 transition-all duration-500 hover:shadow-lg reveal"
