        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6 reveal" style={{ transform: 'translateY(20px)' }}>
            ...
            <div className="flex flex-wrap gap-4 pt-2 animate-fade-in" style={{ animationDelay: '0.9s' }}>
              <Button variant="primary" rounded="md" size="default" asChild>
            ...
            <div className="mt-6 p-4 bg-gradient-to-br from-white/80 to-pelican-cream/80 backdrop-blur-sm rounded-lg border border-secondary/20 shadow-sm animate-fade-in" style={{ animationDelay: '1.3s' }}>
              <div className="flex items-center mb-2">
                <MapPin className="w-5 h-5 text-primary mr-2" />
                <h3 className="text-primary font-heading font-medium text-lg">Free Construction Tools</h3>
              </div>
              <p className="text-sm text-gray-800 mb-3 font-body">Access our suite of free estimating and forecasting tools:</p>
              <div className="grid grid-cols-2 gap-2 text-sm">
                <a href="/labor-burden-calculator" className="flex items-center text-secondary hover:underline transition-all duration-300 hover:translate-x-1 font-medium">
                  <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                  </svg>
                  Labor Burden Calculator
                </a>
                <a href="/estimating-maturity" className="flex items-center text-secondary hover:underline transition-all duration-300 hover:translate-x-1 font-medium">
                  <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
