...
const LaborBurdenCalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-pelican-cream/30 font-body">
      ...
      <main className="content-container py-12 sm:py-16 md:py-20 lg:py-[80px] animate-fade-in relative z-10">
        <div className="text-center mb-8 lg:mb-[48px]">
          ...
          <p className="text-pelican-slate text-center mb-8 max-w-3xl mx-auto text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          <div className="lg:col-span-7">
            <Card className="shadow-md hover:shadow-lg transition-all duration-500 border-pelican-teal/20 bg-white rounded-lg h-full">
              <CardHeader className="bg-gradient-to-r from-pelican-navy to-pelican-navy/90 text-white rounded-t-lg p-6">
                <CardTitle className="text-xl sm:text-2xl font-heading font-medium text-white">Input Labor Data</CardTitle>
          ...
          <div className="lg:col-span-5">
            <Card className="shadow-md hover:shadow-lg transition-all duration-500 border-pelican-teal/20 bg-white rounded-lg h-full">
              <CardHeader className="bg-gradient-to-r from-pelican-teal to-pelican-teal/90 text-white rounded-t-lg p-6">
                <CardTitle className="text-xl sm:text-2xl font-heading font-medium text-white">Results</CardTitle>
                <CardDescription className="text-white/90 text-base sm:text-lg">
        ...
        <div className="mt-12 sm:mt-16 lg:mt-[48px] mb-8 lg:mb-[48px] bg-white p-8 rounded-lg shadow-md border border-pelican-teal/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-heading font-medium text-pelican-navy mb-3">Accurate Bidding</h3>
              <p className="text-pelican-slate leading-relaxed">Ensure your bids cover the true cost of labor, helping maintain profitability</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-heading font-medium text-pelican-navy mb-3">Budget Planning</h3>
              <p className="text-pelican-slate leading-relaxed">Better predict labor costs for improved project budgeting and cash flow management</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-heading font-medium text-pelican-navy mb-3">Competitive Edge</h3>
              <p className="text-pelican-slate leading-relaxed">Make informed decisions about labor pricing to stay competitive while maintaining margins</p>
            </div>
          </div>
        </div>
      </main>
